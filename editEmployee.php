...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    echo "<tr><td>Email</td><td><input name='Email_Address' type='email' size='40' value='$row[Email_Address]'></td></tr>";
    echo "<tr><td>Home Address</td><td><input name='Home_Address' type='text' size='40' value='$row[Home_Address]'></td></tr>";
    echo "<tr><td>Phone Number</td><td><input name='Phone_Number' type='text' size='13' value='$row[Phone_Number]'></td></tr>";
